...
export function Features() {
  return (
    <section id="solutions" className="section-normal bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="p-8 rounded-2xl border border-slate-200/80 bg-white shadow-(--shadow-card) hover:shadow-(--shadow-card-hover) hover:border-slate-200 hover:-translate-y-1 transition-all duration-300 ease-out group"
            >
              <div className="w-12 h-12 rounded-xl bg-brand-100 flex items-center justify-center text-brand-600 mb-6 group-hover:bg-brand-600 group-hover:text-white transition-colors duration-300">
