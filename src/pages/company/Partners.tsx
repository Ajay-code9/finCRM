          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-display font-bold text-slate-900 leading-tight mb-6">
                Powered by <span className="text-brand-600">Industry Leaders</span>
              </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {partners.map((partner, i) => (
              <motion.div
                ...
                className="flex items-center justify-center p-6 bg-white rounded-2xl border border-slate-100 shadow-md hover:shadow-[0_18px_45px_-20px_rgba(16,185,129,0.6)] hover:-translate-y-1 transition-all"
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Button
                className="bg-linear-to-r from-brand-600 via-brand-500 to-emerald-500 text-white rounded-xl px-8 py-3 text-lg"
